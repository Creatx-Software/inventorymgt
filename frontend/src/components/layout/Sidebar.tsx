...
import {
  ...
  UserCog, ShieldCheck, CheckSquare, ShieldAlert, PackageOpen, StickyNote, Activity, Flame,
} from 'lucide-react';
...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/firewalls',  label: 'Firewall Rules',  icon: Flame,         permission: 'firewalls_view' },
